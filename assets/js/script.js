...
const illegal = ['shift', 'alt', 'control', 'tab', 'meta', 'arrowleft', 'arrowup', 'arrowright', 'arrowdown', 'enter', 'backspace', 'escape', 'f1', 'f2', 'f3', 'f4', 'f5', 'f6', 'f7', 'f8', 'f9', 'f10', 'f11', 'f12']
...
let playSound = function (x) {
  x.play();
  x.volume = .5;
}

let stopSound = function (x) {
  x.stop();
}
